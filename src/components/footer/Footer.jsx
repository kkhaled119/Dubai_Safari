    ...
    <footer className="footer">
      ...
      <div className="footer-item">
        ...
        <ul className="footer-item-list">
          ...
          <li className="footer-item-link">Become a Affiliate Partner</li>
        </ul>
        <div className="footer-icons">
          <div className="icon">
            <i style={{ color: "#c0392b" }} className="bi bi-instagram">
              {" "}
            </i>
          </div>
          <div className="icon">
            <i style={{ color: "#3498db" }} className="bi bi-facebook"></i>
          </div>
          <div className="icon">
